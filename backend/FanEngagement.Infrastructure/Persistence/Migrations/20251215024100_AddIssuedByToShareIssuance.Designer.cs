...
namespace FanEngagement.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20251215024100_AddIssuedByToShareIssuance")]
    partial class AddIssuedByToShareIssuance
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FanEngagement.Domain.Entities.Organization", b =>
                {
                    ...
                    b.Property<string>("BlockchainAccountAddress")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)");

                    b.Property<string>("BlockchainConfig")
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("FanEngagement.Domain.Entities.OrganizationFeatureFlag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("OrganizationId", "Feature")
                        .IsUnique();

                    b.ToTable("OrganizationFeatureFlags", (string)null);
                });
            ...
            modelBuilder.Entity("FanEngagement.Domain.Entities.Proposal", b =>
                {
                    ...
                    b.Property<string>("BlockchainProposalAddress")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)");
                    ...
                    b.Property<string>("LatestContentHash")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");

                    b.Property<string>("LatestResultsHash")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
            ...
            modelBuilder.Entity("FanEngagement.Domain.Entities.ShareType", b =>
                {
                    ...
                    b.Property<string>("BlockchainMintAddress")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)");
            ...
            modelBuilder.Entity("FanEngagement.Domain.Entities.UserWalletAddress", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("UserId", "BlockchainType")
                        .IsUnique()
