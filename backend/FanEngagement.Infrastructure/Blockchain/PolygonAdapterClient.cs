...
/// </summary>
public class PolygonAdapterClient(IHttpClientFactory httpClientFactory, string? blockchainConfig) : IBlockchainAdapter
{
    ...
    {
        var client = httpClientFactory.CreateClient("PolygonAdapter");
